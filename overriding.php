<?php 
    /**
     * Inherited methods can be overridden by redefining the methods with the same name in the child class
     */
     ...
     class PhpStudents extends Students{
        ...
        public function message()
        {
            echo "The Student is $this->name, the laptop is $this->laptop and the server is $this->xampp";
        }
     }
